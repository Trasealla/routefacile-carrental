...
@Entity('rates_monthly_v2')
export class RateMonthlyV2 {
  ...
  @Column({ type: 'int', nullable: true, comment: 'Vehicle model year (e.g., 2023, 2024, 2025). NULL means rate applies to all years.' })
  model_year: number;
  ...
  @Column('float', { precision: 10, scale: 2 })
  extra_1000_km_rate: number

  @Column('float', { precision: 10, scale: 2 })
  extra_2000_km_rate: number

  @Column('float', { precision: 10, scale: 2 })
  extra_3000_km_rate: number
