            ...
            <Col md={8}>
              <Form.Group controlId="email">
                ...
                <Form.Control
                  ...
                  onChange={handleParamChange}
                  placeholder={t("Enter user email to search...")}
                  className="shadow-sm"
                />
              </Form.Group>
            </Col>
        ...
        <Col>
          ...
          <Table className="table table-responsive table-striped table-hover" style={{ fontSize: "0.9rem" }}>
            ...
            <tbody>
              ...
              {incompleteBookings?.length === 0 && !loading && <tr className="text-center"><td colSpan={100}>{t("No Data Found.")}</td></tr>}
          ...
          <div className="d-flex justify-content-between align-items-center">
            ...
            <Col lg="2">
              <Form.Group className="mb-3">
                ...
                <Form.Select aria-label={t("Default select example")}
                  name="pageSize"
                  value={pageSize}
