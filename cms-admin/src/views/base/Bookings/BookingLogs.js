...
const handleSearchClick =()=>{
    ...
    <Row className="justify-content-between">
      ...
      <div className="calender-field-width col-lg-2">
            <Form.Group className="mb-3">
              ...
              >
                ...
                <option key='now' value='now'>{t("Pay Now")}</option>
                <option key='later' value='later'>{t("Pay Later")}</option>
              </Form.Select>
              </Form.Group>
              </div>
              <div className="calender-field-width col-lg-2">
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              <div className="calender-field-width col-lg-2">
          <Form.Group className="mb-3">
            <Form.Label>{t("Log Number")}</Form.Label>
            <Form.Control
                  type="text"
                  name="logNumber"
                  value={logNumber}
      ...
      <div className="calender-field-width col-lg-2">
        <Form.Group controlId="pickup_end_date" className="mb-3">
           ...
           <div className="hidden-search-text">{t("Search")}</div>
              <Button className="btn-def btn-icon" onClick={handleSearchClick}><ion-icon className="search-icon" name="search-outline"></ion-icon>{t("Search")}</Button>
  ...
  <tr>
    ...
    <th scope="col">{t("ID")}</th>
      ...
      <th scope="col">{t("ARC#")}</th>
      <th scope="col">{t("Log#")}</th>
      <th scope="col">{t("Type")}</th>
      <th scope="col">{t("Payment")}</th>
      <th scope="col">{t("Days")}</th>
      <th scope="col">{t("Months")}</th>
      <th scope="col">{t("Extra Days")}</th>
      <th scope="col">{t("Booking Date")}</th>
      <th scope="col">{t("User Name")}</th>
      <th scope="col">{t("User Email")}</th>
      <th scope="col">{t("User Phone")}</th>

      <th scope="col">{t("Pickup")}</th>
      <th scope="col">{t("Pickup Location")}</th>
      <th scope="col">{t("Pickup Address")}</th>
      <th scope="col">{t("Pickup Date Time")}</th>
      <th scope="col">{t("Dropoff")}</th>
      <th scope="col">{t("Dropoff Location")}</th>
      <th scope="col">{t("Dropoff Address")}</th>
      <th scope="col">{t("Dropoff Date Time")}</th>
      ...
      <th scope="col">{t("Payment Triggered")}</th>
      <th scope="col">{t("Payment Status")}</th>
      <th scope="col">{t("Payfort ID")}</th>
      <th scope="col">{t("Car Extras")}</th>
      <th scope="col">{t("Payfort Response")}</th>
...
{priceListArray?.length === 0 && !loading &&  <tr  className="text-center"><td colSpan={100}>{t("No Data Found.")}</td></tr>}
