        ...
        .then((res) => {
          if (res?.status === "success") {
            ...
            notifySuccess(t("Updated Successfully"));
              ...
              notifySuccess(t("Created Successfully"));
            }
      ...
      <Row>
        ...
        >
          <Link to="/dynamic-pricing/surge-pricing">
            <Button className="btn-def">{t("Surge List")}</Button>
          </Link>
        </Col>
      </Row>
      </div>
        ...
        <Row className="mb-3">
          ...
          <Col className="mb-3" xs={12} md={6} lg={4}>
            <Form.Group controlId="cdw">
              ...
              />
              <Form.Control.Feedback type="invalid">
                {t("Please enter a CDW.")}
              </Form.Control.Feedback>
            </Form.Group>
          </Col>
          <Col className="mb-3" xs={12} md={6} lg={4}>
            <Form.Group controlId="scdw">
              <Form.Label>{t("SCDW")}</Form.Label>
              <Form.Control
                type="number"
                name="scdw"
                value={formData.scdw}
              ...
              />
              <Form.Control.Feedback type="invalid">
                {t("Please enter a SCDW.")}
              </Form.Control.Feedback>
            </Form.Group>
          </Col>
          <Col className="mb-3" xs={12} md={6} lg={4}>
            <Form.Group controlId="pai">
              <Form.Label>{t("PAI")}</Form.Label>
              <Form.Control
                type="number"
                name="pai"
                value={formData.pai}
              ...
              />
              <Form.Control.Feedback type="invalid">
                {t("Please enter a PAI.")}
              </Form.Control.Feedback>
            </Form.Group>
          </Col>
          <Col className="mb-3" xs={12} md={6} lg={4}>
            <Form.Group controlId="gps">
              <Form.Label>{t("GPS")}</Form.Label>
              <Form.Control
                type="number"
                name="gps"
                value={formData.gps}
              ...
              />
              <Form.Control.Feedback type="invalid">
                {t("Please enter a GPS.")}
              </Form.Control.Feedback>
            </Form.Group>
          </Col>
          <Col className="mb-3" xs={12} md={6} lg={4}>
            <Form.Group controlId="baby_seat">
              <Form.Label>{t("Baby Seat")}</Form.Label>
              <Form.Control
                type="number"
                name="baby_seat"
