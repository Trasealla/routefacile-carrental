      ...
      <Row>
        ...
        >
          <Link to="/dynamicpricing/create-monthly-coupon-code">
            <Button className="btn-def">{t("Add Coupon")}</Button>
          </Link>
        </Col>
      </Row>
        ...
        <Table className="table table-responsive">
          <thead className="text-center">
            <tr>
              ...
              <th scope="col" colSpan={3}>{t("From Date")}</th>
              <th scope="col">{t("To Date")}</th>
              {/* <th scope="col">Type</th> */}
              <th scope="col">{t("Status")}</th>
              <th scope="col">{t("CDW")}</th>
              <th scope="col">{t("SCDW")}</th>
              <th scope="col">{t("PAI")}</th>
              <th scope="col">{t("GPS")}</th>
              <th scope="col">{t("Baby Seat")}</th>
              <th scope="col">{t("Driver")}</th>
              <th scope="col">{t("Rate")}</th>
              <th scope="col">{t("Created By")}</th>
              <th scope="col">{t("Created At")}</th>
              <th scope="col" style={{ paddingRight: "30px" }}>{t("Action")}</th>
