    ...
    <Container fluid className="py-4">
          ...
          <Row className="align-items-center">
            <Col xs={12} md={6}>
              <h4 className="mb-0 fw-bold text-primary">
                {id ? t("Edit Monthly Coupon Code") : t("Create Monthly Coupon Code")}
              </h4>
              <small className="text-muted">
                {id ? t("Update the monthly coupon details below") : t("Fill in the details to create a new monthly discount coupon")}
              </small>
            </Col>
      ...
      {editLoading ? (
        ...
        >
              ...
              <Row>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="discount_type">
                    <Form.Label className="fw-medium">{t("Discount Type")} <span className="text-danger">*</span></Form.Label>
                    <Form.Select
                      name="discount_type"
          ...
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">{t("Validity Period & Rate")}</h6>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={12} md={6} lg={3} className="mb-3">
