...
if(id){
  ...
  useEffect(() => {
    if (carArray?.length > 0) {
      ...
      setMappedCarArray([{ value: "all", label: t("All") }, ...carArrayTemp]);
    }
  }, [carArray]);
          ...
          <Row className="align-items-center">
            <Col xs={12} md={6}>
              <h4 className="mb-0 fw-bold text-primary">
                {id ? t("Edit Coupon Code") : t("Create New Coupon Code")}
              </h4>
              <small className="text-muted">
                {id ? t("Update the coupon details below") : t("Fill in the details to create a new discount coupon")}
              </small>
            </Col>
      ...
      {editLoading ? (
        <Card className="border-0 shadow-sm">
          <Card.Body className="text-center py-5">
            ...
            <p className="mt-3 text-muted">{t("Loading coupon details...")}</p>
          </Card.Body>
        </Card>
      ) : (
        <Form
        ...
        >
          ...
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">{t("Basic Information")}</h6>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="code">
                    <Form.Label className="fw-medium">{t("Coupon Code")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="text"
                      name="code"
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="status">
                    <Form.Label className="fw-medium">{t("Status")} <span className="text-danger">*</span></Form.Label>
                    <Form.Select
                      name="status"
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group>
                    <Form.Label className="fw-medium">{t("Applicable For")}</Form.Label>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="note">
                    <Form.Label className="fw-medium">{t("Note")}</Form.Label>
                    <Form.Control
                      type="text"
                      name="note"
          ...
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">{t("Validity Period")}</h6>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={12} md={6} className="mb-3">
                  <Form.Group controlId="start_date">
                    <Form.Label className="fw-medium">{t("Start Date")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="date"
                      name="start_date"
                ...
                <Col xs={12} md={6} className="mb-3">
                  <Form.Group controlId="end_date">
                    <Form.Label className="fw-medium">{t("End Date")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="date"
                      name="end_date"
          ...
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">{t("Discount Rates (%)")}</h6>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="rate">
                    <Form.Label className="fw-medium">{t("Rate")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="rate"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="cdw">
                    <Form.Label className="fw-medium">{t("CDW")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="cdw"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="scdw">
                    <Form.Label className="fw-medium">{t("SCDW")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="scdw"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="pai">
                    <Form.Label className="fw-medium">{t("PAI")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="pai"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="gps">
                    <Form.Label className="fw-medium">{t("GPS")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="gps"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="baby_seat">
                    <Form.Label className="fw-medium">{t("Baby Seat")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="baby_seat"
                      placeholder="0"
                ...
                <Col xs={6} md={4} lg={3} className="mb-3">
                  <Form.Group controlId="driver">
                    <Form.Label className="fw-medium">{t("Driver")} <span className="text-danger">*</span></Form.Label>
                    <Form.Control
                      type="number"
                      name="driver"
                      placeholder="0"
          ...
          <Card className="mb-4 border-0 shadow-sm">
            <Card.Header className="bg-light border-0 py-3">
              <h6 className="mb-0 fw-semibold">{t("Applicability")}</h6>
              <small className="text-muted">{t('Select where this coupon applies. Choose "All" or specific items.')}</small>
            </Card.Header>
            <Card.Body>
              <Row>
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="city_ids">
                    <Form.Label className="fw-medium">{t("City")} <span className="text-danger">*</span></Form.Label>
                    <Select
                      isMulti
                      name="city_ids"
                    ...
                    {errors.city_ids && (
                      <div className="invalid-feedback d-block">
                        {t('Please select at least one city or choose "All".')}
                      </div>
                    )}
                  </Form.Group>
                </Col>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="location_ids">
                    <Form.Label className="fw-medium">
                      ...
                      {!formData.city_ids.all && formData.city_ids.ids.length > 0 && (
                        <small className="text-info ms-1">{t("(Filtered by City)")}</small>
                      )}
                    </Form.Label>
                    <Select
                      isMulti
                      ...
                      noOptionsMessage={() =>
                        !formData.city_ids.all && formData.city_ids.ids.length > 0
                          ? t("No locations in selected cities")
                          : t("No locations available")
                      }
                    />
                    {errors.location_ids && (
                      <div className="invalid-feedback d-block">
                        {t('Please select at least one location or choose "All".')}
                      </div>
                    )}
                  </Form.Group>
                </Col>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="group_ids">
                    <Form.Label className="fw-medium">{t("Car Group")} <span className="text-danger">*</span></Form.Label>
                    <Select
                      isMulti
                      name="group_ids"
                    ...
                    {errors.group_ids && (
                      <div className="invalid-feedback d-block">
                        {t('Please select at least one group or choose "All".')}
                      </div>
                    )}
                  </Form.Group>
                </Col>
                ...
                <Col xs={12} md={6} lg={3} className="mb-3">
                  <Form.Group controlId="car_ids">
                    <Form.Label className="fw-medium">{t("Car")} <span className="text-danger">*</span></Form.Label>
                    <Select
                      isMulti
                      name="car_ids"
                      placeholder={t("Select Cars...")}
                    ...
                    {errors.car_ids && (
                      <div className="invalid-feedback d-block">
                        {t('Please select at least one car or choose "All".')}
                      </div>
                    )}
                  </Form.Group>
                </Col>
