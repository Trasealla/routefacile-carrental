    ...
    <Container>
      <Row>
        ...
        >
          <Link to="/stop-sale/create-stop-sale">
            <Button className="btn-def">{t("Add Stop Sale")}</Button>
          </Link>
        </Col>
      </Row>
            ...
            {loading ? (
              ...
              stopSaleListArray?.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td>
                    {item?.car_ids.all ? t("All") : item?.car_ids.ids.toString()}
                  </td>
      ...
      <Modal show={showdel} onHide={handleCloseDel}>
        <Modal.Header closeButton>
          <Modal.Title>{t("Delete Stop Sale !")}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {t("Are you sure you want to delete this stop sale ?")}
        </Modal.Body>
        <Modal.Footer>
          <Button
            className="btn-def"
