...
const EditCity = () => {
  ...
  const validate = () => {
    ...
    if (!formData.contact_number) newErrors.contact_number = t("Contact number is required.");
    if (formData.buffer_hours === "" || formData.buffer_hours === null)  newErrors.buffer_hours = t("Buffer Hours are required.");
    ...
    <Container className="container">
      <div className="post_header">
        <Row>
          ...
          >
            <Link to="/cms/cities">
              <Button className="btn-def">{t("City List")}</Button>
            </Link>
          </Col>
        </Row>
      </div>
      {editLoading ? (
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Row className="mb-3">
            <Col xs={12} md={6} lg={4} xl={3}>
              <Form.Group controlId="name_en" className="mb-3">
                <Form.Label>{t("Name (EN)")}</Form.Label>
                <Form.Control
                  type="text"
                  name="name_en"
            ...
            <Col xs={12} md={6} lg={4} xl={3}>
              <Form.Group controlId="name_ar" className="mb-3">
                <Form.Label>{t("Name (AE)")}</Form.Label>
                <Form.Control
                  type="text"
                  name="name_ar"
            ...
            <Col xs={12} md={6} lg={4} xl={3}>
              <Form.Group controlId="buffer_hours" className="mb-3">
                <Form.Label>{t("Buffer Hours")}</Form.Label>
                <Form.Control
                  type="number"
                  min="0"
                  name="buffer_hours"
            ...
            <Col xs={12} md={6} lg={4} xl={3}>
              <Form.Group controlId="recipients" className="mb-3">
                ...
                <Form.Control
                  type="text"
                  placeholder={t("add mulitple with comma")}
                  name="recipients"
                      ...
                      <Row className="align-items-center mb-3" key={shiftIndex}>
                        ...
                        <Col xs={6} md={6}>
                          <Form.Group
                            ...
                            className="mb-2"
                          >
                            <Form.Label>{/* Shift {shift.shift} */} {t("To Time")}</Form.Label>
                            <Form.Select
          ...
          <Button className="mb-3" type="submit" disabled={loading}>
            {loading ? <Spinner /> : id ? t("Update") : t("Submit")}
          </Button>
        </Form>
      )}
    </Container>
