    ...
    <Container>
        ...
        <Row className="mb-3">
          <Col lg="4">
            <InputGroup>
              ...
              <Form.Control
                type="text"
                placeholder={t("citiesList.searchPlaceholder")}
                value={searchTerm}
        ...
        <div className="table-responsive">
          <Table striped bordered hover className="w-100">
            <thead className="table-light">
              <tr>
                <th>{t("citiesList.colId")}</th>
                <th>{t("citiesList.colName")}</th>
                <th>{t("citiesList.colBufferHours")}</th>
                <th>{t("citiesList.colStatus")}</th>
                <th>{t("citiesList.colAction")}</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
      ...
      <Modal show={showdel} onHide={handleCloseDel}>
        <Modal.Header closeButton>
          <Modal.Title>{t("citiesList.deleteTitle")}</Modal.Title>
        </Modal.Header>
        <Modal.Body>{t("citiesList.deleteConfirm")}</Modal.Body>
        <Modal.Footer>
          <Button
            className="btn-def"
