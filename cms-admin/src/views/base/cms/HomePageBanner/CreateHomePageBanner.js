  ...
  return (
      ...
      <Row>
        ...
        >
          <Link to="/cms/homepagebanners">
            <Button className="btn-def">{t("Banner List")}</Button>
          </Link>
        </Col>
      </Row>
    </div>
    {editLoading ? (
      ...
      <Row>
        ...
        <Col sm={12} md={6} lg={4} xl={4} className="mb-4">
          <Form.Group>
            <Form.Label>{t("Image Alt Text")}</Form.Label>
            <Form.Control
                  type="text"
                  name="alt_text"
      ...
      <Col sm={12} md={6} lg={4} className="mb-4">
          <Form.Group>
          <Form.Label>{t("Mobile Image")}</Form.Label>
        <Form.Control
          type="file"
          name="image"
          accept="image/*"
      ...
      <Col sm={12} md={6} lg={4} className="mb-4">
          <Form.Group>
          <Form.Label>{t("Desktop Image")}</Form.Label>
        <Form.Control
          type="file"
          name="desktop"
          accept="image/*"
      ...
      <Button type="submit"  disabled={loading} className="my-4 px-4 py-2 "> {loading ? <Spinner/> :( id ? t("Update") : t("Submit"))}</Button>
    </Form>
    )}
   </Container>
