...
const CreateAdminPages = () => {
        ...
        if (name === "desktop") {
          if (img.width === 800 && img.height === 403) {
            ...
            setErrors((prevErrors) => ({
              ...prevErrors,
              [name]: t("Image must be exactly 800x403 pixels"),
            }));
          }
        } else if (name === "mobile") {
          if (img.width === 390 && img.height === 196) {
            ...
            setErrors((prevErrors) => ({
              ...prevErrors,
              [name]: t("Image must be exactly 390x196 pixels"),
            }));
          }
        }
      };
  ...
  const formSubmitFunction = () => {
    const body = JSON.stringify({
      ...
      content_ar: formData?.description_ar,
      type: formData?.type,
        ...
        <Row>
          ...
          >
            <Link to="/cms/admin-pages">
              <Button className="btn-def">{t("Page List")}</Button>
            </Link>
          </Col>
        </Row>
      </div>
 ...
 {/* Error messages above tabs */}
       ...
       <Tabs defaultActiveKey="english" id="language-tabs" className="mb-3 admin-page-tabs ">
        ...
        <Tab eventKey="english" title={t("English Content")} tabClassName="w-100"  >

        <Row>
            <Col>
              <Form.Group>
                <Form.Label>{t("Content (EN)")}</Form.Label>
                <CKEditorComponent
                  language="en"
            ...
            {/* Arabic Tab */}
        <Tab eventKey="arabic" title={t("Arabic Content")} tabClassName="w-100">
        <Row>
            <Col className="mt-3">
              <Form.Group>
                <Form.Label>{t("Content (AE)")}</Form.Label>
                <CKEditorComponent
                  language="ae"
                  onContentChange={(content) =>
