    ...
    <div className="career-module">
        ...
        <Row className="align-items-center">
          <Col>
            <div className="d-flex align-items-center">
              ...
              <div>
                <h4 className="career-header-title">{t("Career Applications")}</h4>
                <p className="career-header-subtitle">
                  {t("Review and manage all incoming job applications")}
                </p>
              </div>
            </div>
          </Col>
      ...
      >
        <Row className="align-items-end g-3">
          ...
          <Col lg={3} md={6}>
            <label className="form-label fw-semibold" style={{ fontSize: "0.8rem", color: "#64748b" }}>
              <FaFilter size={10} className="me-1" /> {t("Filter by Status")}
            </label>
            <Form.Select
              value={filterStatus}
          ...
          <Col lg={2} md={4}>
            <div className="d-flex align-items-center gap-2">
              <span style={{ fontSize: "0.8rem", color: "#64748b", whiteSpace: "nowrap" }}>{t("Show")}</span>
              <Form.Select
                value={pageSize}
                    ...
                    >
                      ...
                      <td>
                        <span className={`career-badge ${STATUS_MAP[row.status]?.css || "pending"}`}>
                          {STATUS_MAP[row.status]?.label ? t(STATUS_MAP[row.status].label) : t("N/A")}
                        </span>
                      </td>
