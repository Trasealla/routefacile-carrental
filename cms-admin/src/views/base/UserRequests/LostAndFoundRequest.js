...
const calculatePaginationMessage = () => {
  if (!totalRecords) return t("Showing 0 of 0 entries");
  const startRecord = (currentPage - 1) * pageSize + 1;
  const endRecord = Math.min(startRecord + pageSize - 1, totalRecords);
  return t("Showing {{start}} to {{end}} of {{total}} entries", { start: startRecord, end: endRecord, total: totalRecords });
};
...
const handleSearchList = ()=>{
      ...
      <div className="rf-page-header">
        <div className="rf-page-heading">
          <h3 className="rf-page-title">
            <span className="rf-title-bar" /> {t("Lost & Found Requests")}
          </h3>
  ...
  <tr>
    ...
    <th scope="col" >{t("Reference Number")}</th>
