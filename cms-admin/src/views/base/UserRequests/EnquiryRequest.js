...
const types = [
  ...
  {value: 'individual', name: t("Individual") },
  {value: "corporate", name: t("Corporate") },
]
...
const handleSearchList = ()=>{
    ...
    <Row className="justify-content-between">
      <div className="rf-page-header">
        <div className="rf-page-heading">
          <h3 className="rf-page-title">
            <span className="rf-title-bar" /> {t("Enquiry Requests")}
          </h3>
      ...
      <Row className="rf-filter-card mt-2 mb-4">
        ...
        <Col className="mt-auto mb-3">
          <Button className="rf-add-btn" type="button" onClick={handleSearchList}>{t("Search")}</Button>
        </Col>
      </Row>
      <Col>
  ...
  <tr>
    ...
    <th scope="col" rowSpan="2">{t("Number")}</th>
    <th scope="col" rowSpan="2">{t("Email")}</th>
    <th scope="col" rowSpan="2">{t("Type")}</th>
