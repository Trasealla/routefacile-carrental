...
const CarBrandList = () => {
  ...
  const calculatePaginationMessage = () => {
    ...
    return t("carBrand.showing", { start: startRecord, end: endRecord, total: totalRecords });
  };
      ...
      <Col>
        ...
        >
          <thead className="">
            <tr>
              <th scope="col">#</th>
              <th scope="col">{t("carBrand.name")}</th>
              <th scope="col">{t("carBrand.image")}</th>
              <th scope="col">{t("carBrand.status")}</th>
              <th scope="col">{t("carBrand.createdBy")}</th>
              <th scope="col">{t("carBrand.createdAt")}</th>
          ...
          <tbody className="">
              ...
              carGroupListArray?.map((item, index) => (
                <tr key={item.id}>
                  ...
                  <td className="text-center">
                    ...
                    >
                      {item.status ? t("carBrand.active") : t("carBrand.inactive")}
                    </div>
                  </td>
            ...
            {carGroupListArray?.length === 0 && !loading && (
              <tr className="text-center">
                <td colSpan={100}>{t("carBrand.noData")}</td>
              </tr>
            )}
          </tbody>
        </Table>
