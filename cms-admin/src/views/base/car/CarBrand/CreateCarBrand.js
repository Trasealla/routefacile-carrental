      ...
      <div className="rf-page-header">
        <div className="rf-page-heading">
          <h3 className="rf-page-title">
            <span className="rf-title-bar" /> {id ? t("Edit") : t("Add")} {t("Car Brand")}
          </h3>
          <p className="rf-page-sub">{t("Fill in the brand details below")}</p>
        </div>
        <Link to="/car/brand">
          <Button className="rf-outline-btn">&#8592;&nbsp; {t("Brand List")}</Button>
        </Link>
      </div>
    {editLoading ? (
      ...
      <Row>
        ...
        <Col sm={12} md={6} lg={4} xl={3} className="mb-3">
          <Form.Group>
            <Form.Label>{t("Brand Name (English)")}</Form.Label>
            <Form.Control
                  type="text"
                  name="name_en"
        ...
        <Col sm={12} md={6} lg={4} xl={3} className="mb-3">
          <Form.Group>
            <Form.Label>{t("Brand Name (Arabic)")}</Form.Label>
            <Form.Control
                  type="text"
                  name="name_ar"
      ...
      <Col sm={12} md={6} lg={4} className="mb-3">
          <Form.Group>
          <Form.Label>{t("Brand Image")}</Form.Label>
        <Form.Control
          type="file"
          name="image"
          accept="image/*"
