  ...
  const handleExportExcel = async () => {
    try {
      ...
      const rows = res.data.map((b) => ({
        ...
        "Payment Reference": b.payfort_id || b.fort_id || "",
        "LOR": b.booking_days ?? "",
        "Advanced": b.advanced ?? "",
        "Car Rate": b.car_rate ?? "",
  ...
  const handleExportPDF = async () => {
    try {
      ...
      const page2Cols = [
        ...
        "Payment Reference", "LOR", "Advanced", "Car Rate", "Inter City Change", "Parking", "VMD",
      ...
      <div className="accounts-dashboard">
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "80vh" }}>
          <div className="text-center">
            ...
            <p className="mt-3 text-muted">{t('dashboard.loadingDashboard')}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="accounts-dashboard">
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "80vh" }}>
          <div className="text-center">
            ...
            <h5>{t('dashboard.somethingWentWrong')}</h5>
            <p className="text-muted">{t('dashboard.unableToLoad')}</p>
    ...
    <div className="accounts-dashboard">
            ...
            <div className="d-flex align-items-center mb-1">
              ...
              <div>
                <h4 className="acc-dash-title">
                  {userRole === "accounts" ? t('dashboard.accountsDashboard') : t('dashboard.adminDashboard')}
                </h4>
                <p className="acc-dash-subtitle mb-0">
                  {t('dashboard.realtimeSubtitle')}
                </p>
              </div>
            </div>
          </Col>
            ...
            <Col xs="auto">
              <div className="d-flex align-items-center">
                ...
                <span style={{ fontSize: '0.85rem', fontWeight: 500, color: '#5d7186' }}>
                  {t('dashboard.showingData')} {fromDate} &#8594; {toDate}
                </span>
              </div>
            </Col>
            <Col>
              <div className="d-flex align-items-center justify-content-end flex-wrap gap-2">
                ...
                <button
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, #da2826 0%, #b81f1d 100%)',
                    color: '#fff', fontWeight: 600, fontSize: '0.82rem',
                    cursor: overAllLoading ? 'not-allowed' : 'pointer',
                    boxShadow: '0 2px 8px rgba(218,40,38,0.35)',
                ...
                >
                  {overAllLoading
                    ...
                    : <><FaFilter size={11} /> {t('dashboard.filter')}</>}
                </button>
                {/* Excel button */}
                <button
                ...
                >
                  {exporting ? <Spinner animation="border" size="sm" style={{ color: '#fff' }} /> : <FaFileExcel size={13} />} {t('dashboard.excel')}
                </button>
                {/* PDF button */}
                <button
                ...
                >
                  {exporting ? <Spinner animation="border" size="sm" style={{ color: '#fff' }} /> : <FaFilePdf size={13} />} {t('dashboard.pdf')}
                </button>
              </div>
            </Col>
          </Row>
          ...
          <Card className="acc-kpi-card acc-kpi-bookings">
            <CardBody>
              ...
              <div className="acc-kpi-content">
                <span className="acc-kpi-label">{t('dashboard.totalBookings')}</span>
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-kpi-card acc-kpi-revenue">
            <CardBody>
              ...
              <div className="acc-kpi-content">
                <span className="acc-kpi-label">{t('dashboard.totalRevenue')}</span>
                <h2 className="acc-kpi-value">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-kpi-card acc-kpi-incomplete">
            <CardBody>
              ...
              <div className="acc-kpi-content">
                <span className="acc-kpi-label">{t('dashboard.incompleteBookings')}</span>
                <h2 className="acc-kpi-value">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-kpi-card acc-kpi-refunds">
            <CardBody>
              ...
              <div className="acc-kpi-content">
                <span className="acc-kpi-label">{t('dashboard.cancellations')}</span>
                <h2 className="acc-kpi-value">
          ...
          <Col xs={12}>
            ...
            >
              <CardBody className="d-flex align-items-center">
                ...
                <div className="ms-3">
                  <span className="acc-mini-label">{t('dashboard.pendingApplications')}</span>
                  <h5 className="acc-mini-value mb-0">
                    <AnimatedNumber value={pendingApplications} /> {t('dashboard.applicationsAwaiting')}
                  </h5>
                </div>
                <div className="ms-auto">
                  <Button variant="outline-warning" size="sm">{t('dashboard.reviewNow')}</Button>
                </div>
              </CardBody>
            </Card>
          </Col>
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-mini-card">
            <CardBody className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <span className="acc-mini-label">{t('dashboard.payNow')}</span>
                <h5 className="acc-mini-value mb-0">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-mini-card">
            <CardBody className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <span className="acc-mini-label">{t('dashboard.payLater')}</span>
                <h5 className="acc-mini-value mb-0">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-mini-card">
            <CardBody className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <span className="acc-mini-label">{t('dashboard.completed')}</span>
                <h5 className="acc-mini-value mb-0">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className="acc-mini-card">
            <CardBody className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <span className="acc-mini-label">{t('dashboard.failed')}</span>
                <h5 className="acc-mini-value mb-0">
          ...
          <Card className="acc-chart-card">
            <CardBody>
              <div className="d-flex align-items-center mb-3">
                ...
                <h5 className="acc-chart-title mb-0">{t('dashboard.dailyBookingTrend')}</h5>
              </div>
      ...
      <Row className="mb-2">
        <Col lg={7} className="mb-3">
          <Card className="acc-chart-card h-100">
            <CardBody>
              <h5 className="acc-chart-title mb-3">{t('dashboard.monthlyBookings')}</h5>
          ...
          <Card className="acc-chart-card h-100">
            <CardBody>
              <div className="d-flex align-items-center mb-3">
                ...
                <h5 className="acc-chart-title mb-0">{t('dashboard.paymentBreakdown')}</h5>
              </div>
              <div style={{ height: "300px" }}>
      ...
      <Row className="mb-4">
        <Col xs={12}>
          <Card className="acc-chart-card">
            <CardBody>
              <h5 className="acc-chart-title mb-3">{t('dashboard.bookingStatusDistribution')}</h5>
              <div style={{ height: "300px" }}>
