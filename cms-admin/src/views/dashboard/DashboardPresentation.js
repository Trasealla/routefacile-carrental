    ...
    return (
      <>
        ...
        <Row>
          ...
          <Col xxl={3}>
            <Row>
              ...
              <Col md={6} xxl={12}>
                <StatCard
                  title={t('dashboard.incompleteBookings')}
                ...
                <Row className="g-0">
                  ...
                  <Col lg={4}>
                    <div className="p-3 d-flex flex-column justify-content-between h-100">
                      <CardTitle>{t('dashboard.locationsOverview')}</CardTitle>
                      ...
                      <div className="text-center my-4">
                        ...
                        <p className="text-muted mb-0">{t('dashboard.totalLocations')}</p>
                      </div>

                      {/* Stats Row */}
                      <Row className="text-center">
                        <Col xs={6}>
                          <p className="text-muted mb-2">{t('dashboard.active')}</p>
                          <h3 className="text-dark mb-3">{countsStats?.active_locations || countsStats?.total_locations || 0}</h3>
                        </Col>
                        <Col xs={6}>
                          <p className="text-muted mb-2">{t('dashboard.cars')}</p>
        ...
        <Row>
          <Col xs={12}>
            <Card>
              <ChartCardHeader title={t('dashboard.bookingsByMonth')} />
              <CardBody>
        ...
        <Row>
          <Col lg={3} md={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByPickup')} />
          ...
          <Col lg={3} md={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByDropoff')} />
              <CardBody className="d-flex align-items-center justify-content-center">
          ...
          <Col lg={3} md={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByType')} />
              <CardBody className="d-flex align-items-center justify-content-center">
                {loadingStates["type"] ? (
                  <LoadingSpinner height="200px" />
                ) : (
          ...
          <Col lg={3} md={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByPayment')} />
              <CardBody className="d-flex align-items-center justify-content-center">
        ...
        <Row>
          <Col lg={4}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByCity')} />
              <CardBody>
                {loadingStates["city"] ? (
          ...
          <Col lg={4}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByAction')} />
              <CardBody>
          ...
          <Col lg={4}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsBySource')} />
              <CardBody>
        ...
        <Row>
          <Col xs={12}>
            <Card>
              <ChartCardHeader title={t('dashboard.bookingsByCar')} />
              <CardBody>
                {loadingStates["car"] ? (
        ...
        <Row>
          <Col lg={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByCarGroup')} />
              <CardBody>
                {loadingStates["group"] ? (
                  <LoadingSpinner height="300px" />
                ) : (
          ...
          <Col lg={6}>
            <Card className="card-height-100">
              <ChartCardHeader title={t('dashboard.bookingsByLocations')} />
              <CardBody>
    ...
    <div className="analytics-dashboard">
      ...
      <div className="page-title-box">
        <Row className="align-items-center">
          <Col>
            <h4 className="page-title mb-0">{t('dashboard.analytics')}</h4>
          </Col>
          <Col xs="auto">
            <ol className="breadcrumb m-0">
              <li className="breadcrumb-item"><a href="#">{t('dashboard.dashboards')}</a></li>
              <li className="breadcrumb-item active">{t('dashboard.analytics')}</li>
            </ol>
          </Col>
        </Row>
      </div>
