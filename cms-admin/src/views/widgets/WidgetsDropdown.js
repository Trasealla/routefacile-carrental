    ...
    <Row className={props.className} xs={{ gutter: 4 }} style={{backgroundColor:"#fff"}}>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        ...
        >
          ...
          <p className="fs-4 text-center">{t('Cars')}</p>
        </Card>
      </Col>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        <Card
        ...
        >
          ...
          <p className="fs-4 text-center">{t('All Bookings')}</p>
        </Card>
      </Col>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        <Card
        ...
        >
          ...
          <p className="fs-4 text-center">{t('Upcoming Bookings')}</p>
        </Card>
      </Col>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        <Card className="green-color py-3">
          <h5 className="fs-2 text-center mb-0">0</h5>
          <p className="fs-4 text-center">{t('Current Bookings')}</p>
        </Card>
      </Col>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        <Card className="green-color py-3">
          <h5 className="fs-2 text-center mb-0">558</h5>
          <p className="fs-4 text-center">{t('Past Bookings')}</p>
        </Card>
      </Col>
      <Col sm={6} xl={4} xxl={3} className="my-2 my-lg-4">
        <Card className="green-color py-3">
          <h5 className="fs-2 text-center mb-0">43</h5>
          <p className="fs-4 text-center">{t('Cancelled Bookings')}</p>
        </Card>
      </Col>
    </Row>
  )
