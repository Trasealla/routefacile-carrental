...
const AppHeaderDropdown = () => {
  ...
  const getLogoutPath = () => {
    ...
    const portal = localStorage.getItem("routefacile_login_portal");
  ...
  const clearAuthAndRedirect = () => {
    ...
    localStorage.removeItem("routefacile_login_portal");
    navigate(target);
  };
  //   function getToken() {
  //     const token_item = localStorage.getItem("rf_admin_token");
  //     if (!token_item) {
  //       navigate("/login");
  //       return null;
  //     }
