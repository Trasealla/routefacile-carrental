...
const AppSidebar = () => {
  ...
  const userRoleEncrypted = localStorage.getItem("routefacile_user_role");
  let userRole = "";
      ...
      <CSidebarHeader className="">
        <CSidebarBrand to="/">
          ...
          <svg
            ...
            aria-label="RF"
          >
            <text x="-1" y="34" fontFamily="Poppins, Arial, sans-serif" fontWeight="800" fontSize="40" fill="#da2826">R</text>
            <text x="28" y="34" fontFamily="Poppins, Arial, sans-serif" fontWeight="800" fontSize="40" fill="#FFFFFF">F</text>
            <path d="M2 40 q14 -7 30 -2" stroke="#da2826" strokeWidth="3" fill="none" strokeLinecap="round" />
          </svg>
        </CSidebarBrand>
        <CCloseButton
          className="d-lg-none"
