...
const CAREERS_PUBLIC_URL =
  process.env.REACT_APP_CAREERS_PUBLIC_URL || "https://routefacilecarrental.com/en/careerspage";
...
const configWeb = {
  ...
  /////Blog////
  GET_BLOG_LIST: BASE_URL + "admin/blog",
  POST_BLOG_CREATE: BASE_URL + "admin/blog",
  PUT_BLOG_UPDATE: (id) => `${BASE_URL}admin/blog/${id}`,
  GET_BLOG_DETAILS: (id) => `${BASE_URL}admin/blog/${id}`,
  DELETE_BLOG: (id) => `${BASE_URL}admin/blog/${id}`,
  GET_BLOG_CATEGORY_LIST: BASE_URL + "admin/blog/category",
  GET_BLOG_TAG_LIST: BASE_URL + "admin/blog/tag",
  ...
  ADMIN_BOOKING_CREATE: BASE_URL + "admin/booking-create",
  ADMIN_BOOKING_CUSTOMERS: BASE_URL + "admin/booking-create/customers",
  ADMIN_BOOKING_AVAILABILITY: BASE_URL + "admin/booking-create/availability",
  GET_APP_SETTINGS: BASE_URL + "admin/settings",
  PUT_APP_SETTING: BASE_URL + "admin/settings",
  GET_BROKER_LIST: BASE_URL + "admin/broker",
  GET_BROKER_DETAIL: (id) => BASE_URL + `admin/broker/${id}`,
  POST_BROKER: BASE_URL + "admin/broker",
  PUT_BROKER: (id) => BASE_URL + `admin/broker/${id}`,
  DELETE_BROKER: (id) => BASE_URL + `admin/broker/${id}`,
