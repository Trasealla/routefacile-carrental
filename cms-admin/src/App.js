...
const App = () => {
  ...
  /* Apply RTL direction to <html> when language is Arabic */
  useEffect(() => {
  ...
  return (
    <MantineProvider>
      <ModalsProvider>
        ...
        {/* <HashRouter> */}
        <ToastContainer />
        {/* basename keeps every admin route under /admin so a page refresh
            (e.g. /admin/car/brand) is served by nginx instead of 404'ing to the site. */}
