...
import CreatePost from "./views/base/poost/CreatePost";
...
import Brokers from "./views/base/Brokers/Brokers.js";
import AppSettings from "./views/base/Settings/AppSettings.js";
import CreateBooking from "./views/base/Bookings/CreateBooking/CreateBooking.js";
...
const routes = [
  ...
  { path: "/blog/add-blog", name: "Add Blog", element: CreatePost },
  { path: "/blog/edit-blog/:id", name: "Edit Blog", element: CreatePost },
